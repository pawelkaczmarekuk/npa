...
import { DocumentTaskComponent } from 'app/entities/document-task/document-task.component';
...
describe('Component Tests', () => {
    describe('DocumentTask Management Component', () => {
        let comp: DocumentTaskComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(DocumentTaskComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.documentTasks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
